%Script for Figure S3a
clc;clear;close all;
load('../Data/Data-figure/FigureS3a.mat');
linestyle_list = ["-.", "-","--"];
color_list = [
    [66,138,201]/255
    [239,125,122]/255
...
print('-r1000','-dpng','../Figure/FigureS3/FigureS3a.png');
%%
%Script for Figure S3b
clc;clear;close all;
load('../Data/Data-figure/FigureS3b.mat');
linestyle_list = ["-.", "-","--"];
color_list = [
    [66,138,201]/255
    [239,125,122]/255
...
set(gca,'linewidth',0.8);
set(gcf, 'units', 'centimeters', 'position', [0 0 8.5 7]);
print('-r1000','-dpng','../Figure/FigureS3/FigureS3b.png');